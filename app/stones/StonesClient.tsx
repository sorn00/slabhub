...
function StoneCard({ stone }: { stone: Stone }) {
  ...
  return (
    <div className="bg-[#1a1a2e] rounded-xl overflow-hidden border border-slate-700/50 hover:border-[#d4a847]/50 transition-all group flex flex-col">
      {/* Image */}
      <Link href={`/stones/detail/${stone.slug || stone.stone_id}`} className="block relative aspect-[4/3] bg-slate-800 overflow-hidden">
        {stone.image_url ? (
      ...
      <div className="p-4 flex flex-col flex-1">
        <Link href={`/stones/detail/${stone.slug || stone.stone_id}`} className="block">
        ...
        <div className="mt-auto">
          ...
          <div className="flex gap-2">
            <Link
              href={`/stones/detail/${stone.slug || stone.stone_id}`}
