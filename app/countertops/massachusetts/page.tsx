...
const maTowns = towns.massachusetts

export const metadata: Metadata = {
  title: 'Countertops in Massachusetts | Quarriva',
  description:
    'Browse quartz, granite and marble countertop services across Massachusetts. Find local fabricators in Boston, Worcester, Springfield and every town in between.',
  keywords:
    'countertops Massachusetts, quartz countertops MA, granite countertops Massachusetts, kitchen countertops MA, stone fabricators Massachusetts',
}
...
export default function MassachusettsPage() {
  const byCounty = groupByCounty(maTowns)
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Premium quartz, granite &amp; marble countertops serving {maTowns.length}{' '}
      ...
      >
          ...
          <div key={county} style={{ marginBottom: '48px' }}>
            ...
            >
              {byCounty[county].map((town) => (
                <a
                  key={town.slug}
                  href={`/countertops/massachusetts/${town.slug}`}
                  style={{
                    background: '#1a1a2e',
        ...
        >
          ...
          >
            ...
            quote from local Massachusetts fabricators.
          </p>
          <a
            href="/stones"
            style={{
