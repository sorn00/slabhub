...
const ctTowns = towns.connecticut

export const metadata: Metadata = {
  title: 'Countertops in Connecticut | Quarriva',
  description:
    'Browse quartz, granite and marble countertop services across Connecticut. Find local fabricators in Bridgeport, New Haven, Stamford and every town in between.',
  keywords:
    'countertops Connecticut, quartz countertops CT, granite countertops Connecticut, kitchen countertops CT, stone fabricators Connecticut',
}
...
export default function ConnecticutPage() {
  const byCounty = groupByCounty(ctTowns)
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Premium quartz, granite &amp; marble countertops serving {ctTowns.length}{' '}
      ...
      >
          ...
          <div key={county} style={{ marginBottom: '48px' }}>
            ...
            >
              {byCounty[county].map((town) => (
                <a
                  key={town.slug}
                  href={`/countertops/connecticut/${town.slug}`}
                  style={{
                    background: '#1a1a2e',
        ...
        >
          ...
          >
            ...
            quote from local Connecticut fabricators.
          </p>
          <a
            href="/stones"
            style={{
