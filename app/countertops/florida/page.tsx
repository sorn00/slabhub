...
const flTowns = towns['florida']

const serviceArea = 'Quarriva Partner Network — Coming to your area soon'

export const metadata: Metadata = {
  title: 'Countertops in Florida | Quarriva',
  description:
    'Browse quartz, granite and marble countertop services across Florida. Find local fabricators in Miami, Orlando, Tampa, Jacksonville, Fort Lauderdale and beyond.',
  keywords:
    'countertops Florida, quartz countertops FL, granite countertops Florida, kitchen countertops FL, stone fabricators Florida',
}
...
export default function FloridaPage() {
  const byCounty = groupByCounty(flTowns)
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Premium quartz, granite &amp; marble countertops serving {flTowns.length}{' '}
          cities and towns across Florida.
        </p>
      ...
      >
          ...
          <div key={county} style={{ marginBottom: '48px' }}>
            ...
            >
              {byCounty[county].map((town) => (
                <a
                  key={town.slug}
                  href={`/countertops/florida/${town.slug}`}
                  style={{
                    background: '#1a1a2e',
        ...
        >
          ...
          >
            ...
            quote from Florida fabricators coming to your area.
          </p>
          <a
            href="/stones"
            style={{
