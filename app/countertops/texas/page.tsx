...
const txTowns = towns['texas']

const serviceArea = 'Quarriva Partner Network — Coming to your area soon'

export const metadata: Metadata = {
  title: 'Countertops in Texas | Quarriva',
  description:
    'Browse quartz, granite and marble countertop services across Texas. Find local fabricators in Houston, Dallas, Austin, San Antonio, Fort Worth and beyond.',
  keywords:
    'countertops Texas, quartz countertops TX, granite countertops Texas, kitchen countertops TX, stone fabricators Texas',
}
...
export default function TexasPage() {
  const byCounty = groupByCounty(txTowns)
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Premium quartz, granite &amp; marble countertops serving {txTowns.length}{' '}
          cities and towns across Texas.
        </p>
      ...
      >
          ...
          <div key={county} style={{ marginBottom: '48px' }}>
            ...
            >
              {byCounty[county].map((town) => (
                <a
                  key={town.slug}
                  href={`/countertops/texas/${town.slug}`}
                  style={{
                    background: '#1a1a2e',
        ...
        >
          ...
          >
            ...
            quote from Texas fabricators coming to your area.
          </p>
          <a
            href="/stones"
            style={{
